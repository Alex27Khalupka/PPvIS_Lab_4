...
public class Calculator {
    ...
    private void inverseFunction(StringBuilder number) {
    ...
    private void sqrtFunction(StringBuilder number) {
        float a = Float.parseFloat(number.toString());
        number.delete(0, number.length());
    ...
    private void logFunction(StringBuilder number) {
        float a = 0;
        float b = 0;
    ...
    private void factFunction(StringBuilder number) {
        float result = 1;
        float a = Float.parseFloat(number.toString());
        for (int i = 1; i <= a; i++) {
            result = result * i;
